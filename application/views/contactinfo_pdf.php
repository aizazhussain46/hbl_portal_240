...
<body>
    <div class="invoice-box">
        ...
        <p>New Contact Information those requested are the following.</p><br>
        ...
        <table width="600" border="1" cellpadding="5" cellspacing="0" bordercolor="#069198" style="border-collapse:collapse;border-width:1px;border-style:solid;border-color:#069198 !important;">
          ...
          <tr>
                ...
                <td width="300"><p><font size="-1"><?php echo $this->input->post('phone');?>.'</font></p></td>
            </tr>                                   
            <tr>
                <td width="300"><p><font size="-1">Cell</font></p></td>
                <td width="300"><p><font size="-1"><?php echo $this->input->post('cell');?></font></p></td>
            </tr>                                   
            <tr>
                <td width="300"><p><font size="-1">Email</font></p></td>
                <td width="300"><p><font size="-1"><?php echo $this->input->post('email');?></font></p></td>
            </tr>                                   
            <tr>
