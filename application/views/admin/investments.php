    ...
    font-family: 'Muli-Regular';padding-left:10px;
        font-size:13px;
          ...
          <form action="<?php echo base_url();?>Admin/investment_search" method="POST" id="f1">
                    ...
                    <input type="text" id="datepickers" class="form-control"  style="width: 120px;float: left;margin-bottom: -23px;float: right;height: 34px;/* font-weight: 100 !important;     font-size: 13px !important;" name="tdate" required="false" placeholder="To date" >
                    
                    <input type="text" id="datepicker" class="form-control"  style="width: 120px;float: left;margin-bottom: -23px;float: right;height: 34px;/* font-weight: 100 !important;     font-size: 13px !important;" name="fdate" required="false" placeholder="From date" >
...
<td>
<button id="inv_file" type="button" style="background: none; border:none;" value="<?php echo $value['file']; ?>" class="pop">
<img src="<?php echo base_url().'investments/'.$value['file'];?>" width="65px" height="50px">
</button>
</td>
...
$(document).ready(function(){
  ...
  var url = 'http://localhost/Projects_CodeIgniter/240/investments';
