...
input#datepickers {
    ...
    font-family: 'Muli-Regular';padding-left:10px;
        font-size:13px;
          ...
          <form action="<?php echo base_url();?>Admin/transaction_search" method="POST" id="f1">
        ...
        <div class="table-responsvie" style="  overflow: auto; ">           
            <table class="table table-striped bordered ">
                <tr style=" background: #696464; color: #fff !important; ">
                    ...
                    <td style=" color: #fff; ">Reference No</td>
...
$result1 = $this->db->get('investoraccountinfo')->result_array();        
