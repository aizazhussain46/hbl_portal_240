...
$sql = "SELECT * FROM AuditTrailAdmin ORDER BY SNO DESC LIMIT $start_from, $limit";  
...
?>
 ...
 ?>             
            ...
            <?php  
$sql = "SELECT COUNT(SNO) FROM AuditTrailAdmin";  
$rs_result = mysqli_query($conn, $sql);  
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<li><center><a href='../Admin/activitylog?page=".$i."'>".$i."</a></center></li>";  
};  
echo $pagLink . "</ul></nav>";  
?>
</div>
...
$('.pagination').pagination({
		...
		hrefTextPrefix : '../Admin/activitylog?page='
    });
	});
</script>            
