...
if($status_page_show== "pending"){
                         //echo "dasd";
$sql = "SELECT * FROM bankinformation where status='pending' AND (RequestDate between '$from_date' and '$to_date')   ORDER BY id DESC LIMIT $start_from, $limit";  
}
                     if($status_page_show== "A"){
$sql = "SELECT * FROM bankinformation where status='A' AND (RequestDate between '$from_date' and '$to_date')   ORDER BY id DESC LIMIT $start_from, $limit";  
                     } 
                     if($status_page_show== "R"){
$sql = "SELECT * FROM bankinformation where status='R' AND (RequestDate between '$from_date' and '$to_date')   ORDER BY id DESC LIMIT $start_from, $limit";  
                     } 
                     if($status_page_show== "O"){
$sql = "SELECT * FROM bankinformation where status='O' AND (RequestDate between '$from_date' and '$to_date')   ORDER BY id DESC LIMIT $start_from, $limit";  
                     }                         else if(empty($status_page_show)){
$sql = "SELECT * FROM bankinformation where status='pending' ORDER BY id DESC LIMIT $start_from, $limit";  
                     }                  
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            ...
            <?php  
$sql = "SELECT COUNT(id) FROM bankinformation";  
$rs_result = mysqli_query($conn, $sql);  
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<li><center><a href='../Admin/bank_info?page=".$i."'>".$i."</a></center></li>";  
};  
echo $pagLink . "</ul></nav>";  
?>
</div>
...
$('.pagination').pagination({
		...
		hrefTextPrefix : '../Admin/bank_info?page='
    });
	});
</script>            
