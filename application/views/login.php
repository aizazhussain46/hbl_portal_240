...
<input required="" type="text" name="folio"  class="form-control" id="exampleInputEmail1" placeholder="Folio Number:A-910093">
</div>
<div class="form-group">
...
<label id="label">
<input  type="radio" value="<?php echo $image['id'];?>" name="imageSecurity"> 
<?php echo '<img src="data:image/png;base64,'.base64_encode($image['img']).'"/>'; ?>

</label>

<?php } ?>    
<a href="<?php echo base_url();?>Customer/forgot_img" class="pull-right" style="margin-bottom: 20px;">(Forgot Image?)</a>
