<?php include "elements/header-bank.php";?>
  ...
  <div class="modal-dialog terms-dialog" style="width:60%;">
    <!-- Modal content-->
    <div class="modal-content ">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">×</button>
        <h3 class="modal-title"><center style=" color: #fff; ">Terms &amp; Conditions 
        </center>
        </h3>
      </div>
...
<p>
   I/We assert that in case I/we opt for investment in fund(s) which is more risky than my/our profile suggests, the risk profile of the account should be assumed accordingly.
</p>
<form action="<?php echo base_url();?>Customer/insertdata" method="POST" style=" background: #efefef; font-size: 14px; padding-top: 14px; padding-bottom: 0px; padding-left: 14px; color: #069198; font-weight: bold; ">
        ...
        <input type="hidden" name="inv_folio_no" value="<?php echo $_SESSION['inv_folio_no']; ?>">
        <input type="hidden" name="inv_name" value="<?php echo $_SESSION['inv_name']; ?>">
        <input type="hidden" name="inv_cnic" value="<?php echo $_SESSION['inv_cnic']; ?>">
        <input type="hidden" name="inv_select_fund_name" value="<?php echo $_SESSION['inv_select_fund_name']; ?>">
        <input type="hidden" name="inv_acc" value="<?php echo $_SESSION['inv_acc']; ?>">
        <input type="hidden" name="inv_select_bank" value="<?php echo $_SESSION['inv_select_bank']; ?>">
        <input type="hidden" name="inv_tamount" value="<?php echo $_SESSION['inv_tamount']; ?>">
        <input type="hidden" name="inv_cinum" value="<?php echo $_SESSION['inv_cinum']; ?>">
        <input type="hidden" name="inv_remark" value="<?php echo $_SESSION['inv_remark']; ?>">
        <input type="hidden" name="inv_file" value="<?php echo $_SESSION['inv_file']; ?>">
      
<input type="checkbox" name="agreed" style="margin-right: 5px;margin-left: 5px" required="">
I confirm acceptance of Terms &amp; Conditions, Notes, Disclaimer and all charges related to this transaction. 
<br>    <br>   </div>
      <div class="modal-footer" style=" text-align: center; ">
        <input type="submit"  class="btn-primary btn" style=" width: ; background: #00a997; " value="Process">
        </form>
...
<li style="padding-top:6px;padding-bottom:6px;">Select Interbank Fund Transfer (IBFT) or any other means of transferring funds.</li>
...
<li style="padding-top:6px;padding-bottom:6px;">Upon successful execution, you will be issued a transaction reference number.</li>
<li style="padding-top:6px;padding-bottom:6px;">
Copy the transaction reference number and paste it in the “Reference Number” box of E-transaction page.
</li>
          ...
          <div class="wrapper">
            <h3> &nbsp;</h3>
              ...
              <div class="form-group row radio-group" style="padding-top: 97px;">
                ...
                <input type="number" class="form-control" name="tamount" title="please provide amount">
                    <?php
                     if(isset($message)){
                         echo $message;
                     } 
            ...
            <label>Reference Number</label>
                  <input type="text" name="cinum" class="form-control" autocomplete="off">
