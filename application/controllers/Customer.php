...
{
$config['upload_path'] = './investments/';
...
if(empty($fund_name) || empty($bank_name) || empty($amount) || empty($ref) || !$this->upload->do_upload('inv_file')){
...
$_SESSION['inv_file'] = $this->upload->data('file_name');
...
$fund_name = explode(':',$this->input->post('inv_select_fund_name'))[1];
$fund_acc = explode(':',$this->input->post('inv_select_fund_name'))[0];
$fund_branch = explode(':',$this->input->post('inv_select_fund_name'))[2];
...
// $mail->From = 'info@hblasset.com';
// $mail->FromName = '';
// $mail->AddAddress($email = 'francisgill42@gmail.com',$result[0]['ACC_TITLE']);
// $mail->Subject = 'Hbl Asset Management (2-Step IBFT Investment)';
...
// <br>
// <br>
// <h2 style="font-size:20px; font-family:Arial, Helvetica, sans-serif;" >Dear '.$name.', </h2>

// <p>Your investment in HBL Asset Management Fund has been received.</p>

// <p style="padding: 10px; margin:0;background-color:#00a997;color: #fff; font-weight: 400;">The transaction details are as follows:</p>
// <table style="width:500px; border:1px solid #ccc;" >

// <tr style="background-color: #f4f4f4">
// <td style="font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">Reference Number</td>
// <td style="font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">'.$ref_id.'</td>
// </tr>

// <tr>
// <td style="font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">Folio Number</td>
// <td style="font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">'.$this->input->post('inv_folio_no').'</td>
// </tr>

// <tr style="background-color: #f4f4f4">
// <td style="font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">Investor Account Title</td>
// <td style="font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">'.$name.'</td>
// </tr>

// <tr>
// <td style="font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">CNIC</td>
// <td style="font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">'.$this->input->post('inv_cnic').'</td>
// </tr>

// <tr style="background-color: #f4f4f4">
// <td style="font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">Fund Invested In</td>
// <td style="font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">'.$fund_name.'</td>
// </tr>

// <tr>
// <td style="font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">Fund Account Number</td>
// <td style="font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">'.$fund_acc.'
// </td>
// </tr>

// <tr style="background-color: #f4f4f4">
// <td style="font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">Fund Account Branch</td>
// <td style="font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">'.$fund_branch.'
// </td>
// </tr>

// <tr>
// <td style="font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">IBFT Processed from</td>
// <td style="font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">'.$this->input->post('inv_select_bank').'
// </td>
// </tr>

// <tr style="background-color: #f4f4f4">
// <td  style="font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">Investment Amount</td>
// <td  style="font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">'.$amount.'
...
// <tr>
// <td  style="background-color: #f4f4f4;font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">IBFT Reference ID</td>
// <td  style="background-color: #f4f4f4;font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">'.$this->input->post('inv_cinum').'
...
// <tr style="background-color: #f4f4f4">
// <td  style="background-color: #fff;font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">Remarks</td>
// <td  style="background-color: #fff;font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">'.$this->input->post('inv_remark').'

// </td>
// </tr>

// <tr>
// <td  style="background-color: #f4f4f4;font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">Date</td>
// <td  style="background-color: #f4f4f4;font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">'.$created_date.'


// </td>
// </tr>
// <tr style="background-color: #f4f4f4">
// <td  style="background-color: #fff;font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">Time</td>
// <td  style="background-color: #fff;font-size:15px;padding-left: 10px;padding-top: 5px;padding-bottom: 5px; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">'.$created_time.'
...
// </table>   
// <br>
// <p style="background-color: #fff;font-size:15px;padding-left: 0px;padding-top: 5px;padding-bottom: 5px; font-size: 16px; font-family:Arial, Helvetica, sans-serif;">
// 	Statement of Investment will be sent shortly.
// </p>

// <div style="background-color: #fff;padding-left:0;padding-top: 5px;padding-bottom: 5px; font-size: 10px; font-family:Arial, Helvetica, sans-serif;">&copy; Copyright 2019 HBL Asset Management Limited. All rights reserved.
// </div>
// </div>
// ';
